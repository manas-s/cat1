...
(function () {
    ...
    d.applyLang = function(a, b) {
        ...
        b.amString = "am";
        b.pmString = "pm";
        c && (c = c[a]) && (d.lang = c, c.monthNames && (b.dayNames = d.extend({}, c.dayNames), b.shortDayNames = d.extend({}, c.shortDayNames), b.monthNames = d.extend({}, c.monthNames), b.shortMonthNames =
    ...
    d.isNN && (document.addEventListener("mousemove", d.handleMouseMove, !0), document.addEventListener("mouseup",
        d.handleMouseUp, !0), window.addEventListener("load", d.handleLoad, !0), window.addEventListener("DOMMouseScroll", d.handleWheel, !0), document.addEventListener("mousewheel", d.handleWheel, !0));
...
(function() {
    ...
    d.AxisBase = d.Class({
        ...
        parseDatesDraw: function() {
            ...
            var u, w = this.gridAlpha,
                A, v = this.choosePeriod(0),
                x = v.period,
                v = v.count,
                y = d.getPeriodDuration(x, v);
            y < k && (x = g.period, v = g.count, y = k);
            g = x;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / y) + 5,
                D = l = d.resetDateToMin(new Date(this.startTime - y), x, v, r).getTime();
            if (g == x && 1 == v && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels) n = y * this.stepWidth, this.autoWrap &&
            ...
            var C = 0,
                J = 0;
            a && 1 < v && (u = this.chooseMinorFrequency(v), A = d.getPeriodDuration(x, u));
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    "DD" == x && (p += 36E5);
                    p = d.resetDateToMin(new Date(p), x, v, r).getTime();
                    "MM" == x && (h = (p - l) / y, 1.5 <= (p - l) / y && (p = p - (h - 1) * y + d.getPeriodDuration("DD",
                        3), p = d.resetDateToMin(new Date(p), x, 1).getTime(), C += y));
                    h = (p - this.startTime) * this.stepWidth;
                    if ("radar" == b.type) {
                        if (0 > h || h > this.axisWidth) continue;
                        h = this.y + (this.axisWidth - h)
                    } else this.rotate ? (h += this.x - this.viX, "date" == this.type && "middle" == this.gridPosition && (J = -y * this.stepWidth / 2)) : h = "date" == this.type ? this.axisWidth - h + (this.y - this.viY) : h + (this.y - this.viY);
                    f = !1;
                    ...
                    if (a == k && !c || a == B && !e) f = " ";
                    this.labelFunction && (f = this.labelFunction(f, new Date(p), this, x, v, m).toString());
                    this.boldLabels && (l = !0);
                    m = new this.axisItemRenderer(this, h, f, !1, n, J, !1, l);
                    this.pushAxisItem(m);
                    m = l = p;
                    if (!isNaN(u))
                        for (h = 1; h < v; h += u) this.gridAlpha = this.minorGridAlpha, f = p + A * h, f = d.resetDateToMin(new Date(f), x, u, r).getTime(),
...
(function() {
    ...
    d.ValueAxis = d.Class({
        ...
        draw: function() {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                var r = Math.round((this.maxCalc - this.minCalc) / this.step) + 1,
                    t;
                !0 === h ? (t = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / t, t > this.logGridLimit && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, f = Math.round(Math.log(this.minReal) * Math.LOG10E), r > this.gridCountR && (p = Math.ceil(r / this.gridCountR)))) : this.stepWidth = this.axisWidth /
                    (this.max - this.min);
                var u = 0;
                ...
                if (0 < x) {
                    ...
                    for (g = this.fillAlpha = 0; g < x; g++) {
                        ...
                        var J = NaN;
                        isNaN(B.value) || (J = this.getCoordinate(B.value), A = new this.axisItemRenderer(this, J, B.label, !0, NaN, (D - J) / 2, B), this.pushAxisItem(A, C));
                        isNaN(D) && (J -= 3, D = J + 3);
                        isNaN(D - J) || (A = new this.guideFillRenderer(this, J, D, B), this.pushAxisItem(A, C), A = A.graphics(), B.graphics = A, B.balloonText && this.addEventListeners(A, B))
                    }
                    this.fillAlpha = y
                }
                this.exponential = !1;
                for (g =
                    f; g < r; g += p) v = d.roundTo(this.step * g + this.min, u), -1 != String(v).indexOf("e") && (this.exponential = !0);
                this.duration && (this.maxInterval = d.getMaxInterval(this.max, this.duration));
                var u = this.step,
                    G, v = this.minorGridAlpha;
                this.minorGridEnabled && (G = this.getMinorGridStep(u, this.stepWidth * u));
                if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                    ...
                    for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) &&
                        (this.labelRotationR = this.autoRotateAngle), g = f; g < r; g += p)
                        if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
                            if (isNaN(w) || Number(d.toFixed(c, w)) == c) {
                                ...
                                var K;
                                this.rotate && this.autoWrap && (K = this.stepWidth * u - 10);
                                A = new this.axisItemRenderer(this,
                                    f, A, void 0, K, void 0, void 0, this.boldLabels);
                                this.pushAxisItem(A);
                                if (c == this.baseValue && "radar" != a.type) {
                                    ...
                                    A = this.viX;
                                    x = this.viY;
                                    "H" == this.orientation ? 0 <= f && f <= y + 1 && (I = [f, f, f + k], X = [B, 0, l]) : 0 <= f && f <= B + 1 && (I = [0, y, y + k], X = [f, f, f + l]);
                                    I && (f = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(this.zeroGridAlpha) || (f = this.zeroGridAlpha), f = d.line(a.container, I, X, this.gridColor, f, 1, this.dashLength), f.translate(A, x), this.grid0 = f, a.axesSet.push(f), f.toBack(), d.setCN(a, f, this.bcn + "zero-grid-" +
                                        this.id), d.setCN(a, f, this.bcn + "zero-grid"))
                                }
                                if (!isNaN(G) && 0 < v && g < r - 1) {
                                    f = this.gridAlpha;
                                    this.gridAlpha = this.minorGridAlpha;
                                    for (A = 1; A < u / G; A++) x = this.getCoordinate(c + G * A), x = new this.axisItemRenderer(this, x, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(x);
                                    this.gridAlpha = f
                                }
                            }
                t = this.baseValue;
            ...
            t = this.labelsSet;
            this.positionTitle();
            "radar" != a.type ? (a = this.viX, G = this.viY, b.translate(a, G), t.translate(a, G)) : h.toFront();
        ...
        getDateMinMax: function() {
            this.minimumDate && (this.minimumDate instanceof Date || (this.minimumDate = d.getDate(this.minimumDate,
                this.chart.dataDateFormat, "fff")), this.min = this.minimumDate.getTime());
        ...
        formatValue: function(a, b, c) {
            ...
            e ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) :
            ...
            "date" ==
            this.type && (c = d.formatDate(new Date(a), this.currentDateFormat, g));
        ...
        stackGraphs: function(a) {
            ...
            if (r && ("regular" == b || "100%" == b))
                for (q = 0; q < k.length; q++) n = k[q], n.hidden || (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable &&
                    (l && (n.stackGraph = l), l = n));
            for (l = this.start; l <= this.end; l++) {
                ...
                for (q = 0; q < k.length; q++)
                    ...
                    if (m = this.data[l].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[l] = NaN, e[l] = NaN);
                        ...
                        f[l] = d.roundTo(f[l], t);
                        u = n.fillToGraph;
                        r && u && (u = this.data[l].axes[this.id].graphs[u.id]) && (m.values.open =
                            u.values.value);
            ...
            for (l = this.start; l <=
                ...
                for (q = 0; q < k.length; q++)(n = k[q], n.hidden) ? n.newStack && (h[l] = NaN, e[l] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (m = this.data[l].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g) || (c = g / f[l] * 100, m.values.percents = c, m.values.total = f[l], n.newStack && (h[l] = NaN, e[l] = NaN), "100%" == b && (isNaN(e[l]) && (e[l] = 0), isNaN(h[l]) && (h[l] = 0), 0 > c ? (m.values.close = d.fitToBounds(c + e[l], -100, 100), m.values.open = e[l], e[l] = m.values.close) : (m.values.close = d.fitToBounds(c + h[l], -100, 100),
                    m.values.open = h[l], h[l] = m.values.close)))))
        },
            ...
            for (c = 0; c < b.length; c++) {
                ...
                if (e.valueAxis == this) {
                    ...
                    for (h = l; h <= k; h++) {
                        ...
                        var l = g.values,
                            p;
                        for (p in l) g.percents[p] =
                            "percents" != p ? l[p] / f * 100 - 100 : l[p]
                    }
                }
            }
        },
        getMinMax: function() {
            ...
            isNaN(this.maximum) && isNaN(this.maxTemp) && (this.max = Math.ceil(this.max /
                e) * e + e);
            ...
            this.logarithmic && (2 < Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E))) : (a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, Math.pow(10,
                Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10 < a && (this.minReal = this.min = 10 * a)))
        },
        getMin: function(a, b) {
            var c, e;
            for (e = a; e <= b; e++) {
                    ...
                    if (d.hasOwnProperty(f)) {
                        ...
                        if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
                            ...
                            if (this.minMaxField) k = g[this.minMaxField], k < c && (c = k);
                                ...
                                for (var l in g) g.hasOwnProperty(l) &&
                                    "percents" != l && "total" != l && (k = g[l], k < c && (c = k))
                        }
                    }
            }
            return c
                    ...
                    if (c.hasOwnProperty(e)) {
                        ...
                        if (d.includeInMinMax && (!d.hidden || this.includeHidden)) {
                            ...
                            if (this.minMaxField) f = d[this.minMaxField], f > a && (a = f);
                                ...
                                for (var g in d) d.hasOwnProperty(g) && "percents" != g &&
                                    "total" != g && (f = d[g], f > a && (a = f))
                        }
                    }
            }
            return a
        ...
        zoomToValues: function(a, b) {
            ...
            "xy" == c.type ? (b < a && (c = b, b = a, a = c), a < this.min && (a = this.min), b > this.max && (b = this.max), c = {
                    type: "axisSelfZoomed"
                }, c.chart = this.chart, c.valueAxis = this, c.multiplier = this.axisWidth /
                Math.abs(this.getCoordinate(b) - this.getCoordinate(a)), c.startValue = a, c.endValue = b, c.position = "V" == this.orientation ? this.reversed ? this.getCoordinate(a) : this.getCoordinate(b) : this.reversed ? this.getCoordinate(b) : this.getCoordinate(a), this.fire(c.type, c)) : (this.minZoom = a, this.maxZoom = b, c.updateAfterValueZoom())
        },
        coordinateToValue: function(a) {
            ...
            var b = this.axisWidth,
                ...
                f = this.min,
                g = this.minReal;
            return !0 === this.logarithmic ? Math.pow(10, (d ? !0 ===
                e ? (b - a) / c : a / c : !0 === e ? a / c : (b - a) / c) + Math.log(g) * Math.LOG10E) : !0 === e ? d ? f - (a - b) / c : a / c + f : d ? a / c + f : f - (a - b) / c
        },
        getCoordinate: function(a, b) {
            ...
            c = this.rotate ? c + (this.x - this.viX) : c + (this.y - this.viY);
            1E7 < Math.abs(c) &&
                (c = c / Math.abs(c) * 1E7);
            b || (c = Math.round(c));
            return c
        ...
        handleSynchronization: function() {
            if (this.synchronizeWith) {
                ...
                e && (this.min = b * e, this.max = c * e, this.step = a * e, b = Math.abs(Math.log(Math.abs(Math.pow(10,
                    Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)))) * Math.LOG10E), this.maxDecCount = b = Math.round(b), this.draw())
            }
        }
    })
})();
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            var fa = a.counter,
                ...
                ba = a.offset,
                ea, ta;
            g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), X = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (J = g.lineColor), void 0 != g.color && (u = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha), isNaN(g.dashLength) || (G = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness), !0 === g.inside && (P = !0, 0 < ba && (ba = 0)), isNaN(g.labelRotation) ||
            ...
            if ("H" == Ra) {
                if (0 <= b && b <= sa + 1 && (0 < B && 0 < y && b + l <= sa + 1 && (ea = d.line(w, [b + l, b + l], [0, B], x, y, C), A.push(ea)), 0 < D && (ta = d.line(w, [b, b + qa, b + qa], [V, V + ka, ka], J, D, C, G), A.push(ta))), z = 0, E = b, g && 90 == n && P && (E -= t), !1 === e ? (ga = "start", z = "bottom" == ca ? P ? z + B : z - B : P ? z - B : z + B, E += 3, 0 < h && (E += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == fa && 0 < I && !g && !m && aa < sa && (e = d.fitToBounds(b, 0, sa), aa = d.fitToBounds(aa, 0, sa), W = e - aa, 0 < W && (wa = d.rect(w, W, a.height, K, I), wa.translate(e - W + qa, ka), A.push(wa))), "bottom" == ca ? (z += V + t / 2 + ba, P ? (0 < n ?
                    ...
                    (f += ha / 2 * Math.cos(S)), Z && (t = 0, P && (t = ha / 2 * Math.cos(S)), f + t > sa + 2 || 0 > f)) Z.remove(), Z = null
            } else {
                0 <= b && b <= V + 1 && (0 < B && 0 < y && b + l <= V + 1 && (ea = d.line(w, [0, B + 1], [b + l, b + l], x, y, C), A.push(ea)), 0 < D && (ta = d.line(w, [0, qa, sa + qa], [b, b + ka, b + ka], J, D, C, G), A.push(ta)));
                ga = "end";
                if (!0 === P && "left" == ca || !1 === P && "right" == ca) ga = "start";
                z = b - Ja / 2 + 2;
                1 == fa && 0 < I && !g && !m && (e = d.fitToBounds(b, 0, V), aa = d.fitToBounds(aa, 0, V), S = e - aa, wa = d.polygon(w, [0, a.width, a.width, 0], [0, 0, S, S], K, I), wa.translate(qa, e - S + ka), A.push(wa));
                z += t / 2;
                "right" == ca ?
                    (E += qa + sa + ba, z += ka, P ? (f || (z -= t / 2 + 3), E = E - (B + 4) - oa) : (E += B + 4 + v, z -= 2, E += oa)) : P ? (E += B + 4 - ba, f || (z -= t / 2 + 3), g && (E += qa, z += ka), E += oa) : (E += -B - v - 4 - 2 - ba, z -= 2, E -= oa);
                ea && ("right" == ca ? (la += qa + ba + sa - 1, W += ka, la = P ? la - v : la + v) : (la -= ba, P || (la -= B + v)));
                f && (z += f);
                P = -3;
                "right" == ca && (P += ka);
                Z && (z > V + 1 || z < P) && (Z.remove(), Z = null)
            }
            ea && (ea.translate(la, W), d.setCN(p, ea, a.bcn + "tick"), d.setCN(p, ea, q, !0), g && d.setCN(p, ea, "guide"));
            !1 === a.visible && (ea && ea.remove(), Z && (Z.remove(), Z = null));
            Z && (Z.attr({
                "text-anchor": ga
            }), Z.translate(E,
                z, NaN, !0), 0 !== n && Z.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Z), this.label = Z, d.setCN(p, Z, a.bcn + "label"), d.setCN(p, Z, q, !0), g && d.setCN(p, Z, "guide"));
            ta && (d.setCN(p, ta, a.bcn + "grid"), d.setCN(p, ta, q, !0), g && d.setCN(p, ta, "guide"));
            wa && (d.setCN(p, wa, a.bcn + "fill"), d.setCN(p, wa, q, !0));
            m ? ta && d.setCN(p, ta, a.bcn + "grid-minor") : (a.counter = 0 === fa ? 1 : 0, a.previousCoord = b);
                ...
                for (e = 0; e < b.length; e++) {
                    ...
                    if (!1 !== h.enabled) {
                        ...
                        var k = this.marginLeft,
                            f = d.wrappedText(this.container, h.text, f, this.fontFamily, g, "middle", !1, this.divRealWidth - 32);
        ...
        brr: function() {
            if (this.hideCredits) {
                ...
                if (c != a || !0 === this.inIframe()) {
                    ...
                    "ammap" == this.product && (g = a + "/javascript-maps/", k =
                        "Interactive JavaScript maps", l = "JS map by amCharts");
    ...
    d.AmGraph = d.Class({
        ...
        createXYGraph: function() {
            ...
            for (d = this.start; d <= this.end; d++) {
                var f =
                    this.data[d].axes[c.id].graphs[this.id],
                    g = f.values,
                    k = g.x,
                    l = g.y,
        ...
        createRadarGraph: function() {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []);
                    ...
                    var r = this.y - (this.valueAxis.getCoordinate(q, this.noRounding) - this.height),
                    ...
                    q = r * Math.sin(t / 180 * Math.PI);
                    r *= Math.cos(t / 180 * Math.PI);
                    b.push(q);
                    c.push(r);
                    if (!isNaN(p)) {
                        var u = this.y - (this.valueAxis.getCoordinate(p,
                                this.noRounding) - this.height),
                            u = u * this.valueAxis.rMultiplier,
                            w = u * Math.sin(t / 180 * Math.PI),
                    ...
                    t = this.createBullet(n, q, r, m);
                    n.x = q;
                    n.y = r;
                    if (w = this.labelText) n = this.createLabel(n, q, r, w), this.positionLabel(q, r, n, t), this.allBullets.push(n);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = r)
                }
            }
        ...
        positionLabel: function(a, b, c, e) {
            ...
            if (e) {
                var l = e.graphDataItem,
                    ...
                    p = this.valueAxis;
                b -= k.height / 4 / 2;
                void 0 !== l.labelIsNegative && (n = l.labelIsNegative);
                switch (g) {
                    case "top":
                ...
                switch (g) {
                    case "top":
                        b = p.reversed ? b + (e.size / 2 +
                            k.height / 2 + w) : b - (e.size / 2 + k.height / 2 + w);
                        break;
                    case "right":
                        d = "start";
                        a += e.size / 2 + w;
                        break;
                    case "bottom":
                        b = p.reversed ? b - (e.size / 2 + k.height / 2 + w) : b + (e.size / 2 + k.height / 2 + w);
                        break;
                    case "left":
                        d = "end";
                        a -= e.size / 2 + w;
                        break;
                    case "inside":
                        "column" == this.type && (f = !0, m ? n ? (d = "end", a = t - 3 - w) : (d = "start", a = t + 3 + w) : b = n ? u + 7 + w : u - 10 - w);
                        break;
                    case "middle":
                        "column" == this.type && (f = !0, m ? a -= (a - t) / 2 + w - 3 : b -= (b - u) / 2 + w - 3)
                }
        ...
        createSerialGraph: function() {
            ...
            var m = this.useNegativeColorIfDown,
                ...
                A = [],
                v = [],
                x, y, B, D, C = this.chart.graphs.length,
                J, G = this.dx / this.tcc,
                K = this.dy / this.tcc,
                I = f.stackType,
                X = this.start,
                fa = this.end,
            ...
            if (!(P || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ka && void 0 == Da || m))) {
                ...
                r ? (ha = q, Ja = Math.abs(Lb - Ga) + 1, rb = q, sb = Math.abs(gb - Ga) + 1, fb = qb = 0, f.reversed ? (Z = 0, eb = Ga) : (Z = Ga, eb = 0)) : (Ja = n, ha = Math.abs(Lb - Ga) + 1, sb = n, rb = Math.abs(gb - Ga) + 1, eb = Z = 0, f.reversed ? (fb = p, qb = Ga) : fb = Ga + 1)
            }
            var Ha = Math.round;
            this.pmx = Ha(Z);
            this.pmy = Ha(qb);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < X) {
                    for (L = X - 1; - 1 < L; L--)
                        if (E = e[L], z = E.axes[f.id].graphs[b], la = z.values.value, !isNaN(la)) {
                            X = L;
                            break
                        }
                    if (this.lineColorField)
                        for (L = X; - 1 < L; L--)
                            if (E = e[L], z = E.axes[f.id].graphs[b], z.lineColor) {
                                this.bulletColorSwitched = this.lineColorSwitched = z.lineColor;
                                break
                            }
                    if (this.fillColorsField)
                        for (L = X; - 1 < L; L--)
                            if (E = e[L], z = E.axes[f.id].graphs[b], z.fillColors) {
                                this.fillColorsSwitched = z.fillColors;
                                break
                            }
                    if (this.dashLengthField)
                        for (L = X; - 1 < L; L--)
                            if (E = e[L], z = E.axes[f.id].graphs[b], !isNaN(z.dashLength)) {
                                this.dashLengthSwitched = z.dashLength;
                                break
                            }
                }
                if (fa < e.length - 1)
                    for (L = fa + 1; L < e.length; L++)
                        if (E = e[L], z = E.axes[f.id].graphs[b], la = z.values.value, !isNaN(la)) {
                            fa = L;
                            break
                        }
            ...
            for (L = X; L <= fa; L++) {
                E = e[L];
                z = E.axes[f.id].graphs[b];
                z.index = L;
                var Za, Na = NaN;
                if (m && void 0 ==
                    this.openField)
                    for (var xb = L + 1; xb < e.length && (!e[xb] || !(Za = e[L + 1].axes[f.id].graphs[b]) || !Za.values || (Na = Za.values.value, isNaN(Na))); xb++);
                var Q, O, M, da, ma = NaN,
                    H = NaN,
                    F = NaN,
                    R = NaN,
                    ...
                    Ta = Wa,
                    Ba = sa,
                    ua, za, Ab = this.proCandlesticks,
                    kb = this.topRadius,
                    $a = this.pattern;
                void 0 != z.pattern && ($a = z.pattern);
                isNaN(z.alpha) || (Ta = z.alpha);
                isNaN(z.dashLength) || (ba = z.dashLength);
                var Ca = z.values;
                f.recalculateToPercents && (Ca =
                    z.percents);
                if (Ca) {
                    Y = this.stackable && "none" != I && "3d" != I ? Ca.close : Ca.value;
                    if ("candlestick" == g || "ohlc" == g) Y = Ca.close, zb = Ca.low, Ea = f.getCoordinate(zb), yb = Ca.high, Fa = f.getCoordinate(yb);
                    na = Ca.open;
                    F = f.getCoordinate(Y, ub);
                    isNaN(na) || (N = f.getCoordinate(na, ub), m && "regular" != I && "100%" != I && (Na = na, na = N = NaN));
                    m && (void 0 == this.openField ? Za && (Za.isNegative = Na < Y ? !0 : !1, isNaN(Na) && (z.isNegative = !Ma)) : z.isNegative = Na > Y ? !0 : !1);
                    ...
                    "step" != g || isNaN(E.cellWidth) || (W = E.cellWidth);
                    var ra = Math.floor(W / 2) + Math.floor(Ua * W / 2),
                        Aa = ra,
                        lb = 0;
                    "left" == this.stepDirection && (lb = (2 * W + Ua * W) / 2, ma -= lb);
                    "center" == this.stepDirection && (lb = W / 2, ma -= lb);
                    "start" == this.pointPosition && (ma -= W / 2 + Math.floor(Ua * W / 2), ra = 0, Aa = Math.floor(W) + Math.floor(Ua * W));
                    "end" == this.pointPosition && (ma += W / 2 + Math.floor(Ua * W / 2), ra = Math.floor(W) + Math.floor(Ua * W), Aa = 0);
                    if (Nb) {
                        var Bb = this.columnWidth;
                        isNaN(Bb) || (ra *=
                            Bb, Aa *= Bb)
                    }
                    P || (z.x = ma); - 1E5 > ma && (ma = -1E5);
                    ma > n + 1E5 && (ma = n + 1E5);
                    r ? (H = F, R = N, N = F = ma, isNaN(na) && !this.fillToGraph && (R = ka), Oa = Ea, Pa = Fa) : (R = H = ma, isNaN(na) && !this.fillToGraph && (N = ka));
                    if (!Ab && Y < na || Ab && Y < ta) z.isNegative = !0, Ka && (Ia = Ka), Xa && (Ta = Xa), void 0 != Da && (Ba = Da);
                    Ya = !1;
                    isNaN(Y) || (m ? Y > Na ? (Ma && (Ya = !0), Ma = !1) : (Ma || (Ya = !0), Ma = !0) : z.isNegative = Y < Ra ? !0 : !1, ta = Y);
                    var Ob = !1;
                    P && a.chartScrollbar.ignoreCustomColors && (Ob = !0);
                    Ob || (void 0 != z.color && (Ia = z.color), z.fillColors && (Ia = z.fillColors));
                    switch (g) {
                        case "line":
                            if (isNaN(Y)) w ||
                                (this.drawLineGraph(A, v, T, U), A = [], v = [], T = [], U = []);
                            else {
                                if (Math.abs(H - hb) >= jb || Math.abs(F - ib) >= jb) A.push(H), v.push(F), hb = H, ib = F;
                                xa = H;
                                ya = F;
                                ia = H;
                                ja = F;
                                !La || isNaN(N) || isNaN(R) || (T.push(R), U.push(N));
                                if (Ya || void 0 != z.lineColor || void 0 != z.fillColors || !isNaN(z.dashLength)) this.drawLineGraph(A, v, T, U), A = [H], v = [F], T = [], U = [], !La || isNaN(N) || isNaN(R) || (T.push(R), U.push(N)), m ? Ma ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched = Da, this.fillColorsSwitched = Ka) : (this.lineColorSwitched =
                                    z.lineColor, this.fillColorsSwitched = z.fillColors), this.dashLengthSwitched = z.dashLength;
                                z.gap && (this.drawLineGraph(A, v, T, U), A = [], v = [], T = [], U = [])
                            }
                            break;
                        case "smoothedLine":
                            if (isNaN(Y)) w || (this.drawSmoothedGraph(A, v, T, U), A = [], v = [], T = [], U = []);
                            else {
                                if (Math.abs(H - hb) >= jb || Math.abs(F - ib) >= jb) A.push(H), v.push(F), hb = H, ib = F;
                                xa = H;
                                ya = F;
                                ...
                                ja = F;
                                !La || isNaN(N) || isNaN(R) || (T.push(R), U.push(N));
                                void 0 == z.lineColor && void 0 == z.fillColors && isNaN(z.dashLength) || (this.drawSmoothedGraph(A, v, T, U), A = [H], v = [F], T = [], U = [], !La || isNaN(N) || isNaN(R) || (T.push(R), U.push(N)), this.lineColorSwitched = z.lineColor, this.fillColorsSwitched = z.fillColors, this.dashLengthSwitched = z.dashLength);
                                z.gap && (this.drawSmoothedGraph(A, v, T, U), A = [], v = [], T = [], U = [])
                            }
                            break;
                        case "step":
                            if (!isNaN(Y)) {
                                r ? (isNaN(x) || (A.push(x), v.push(F - ra)), v.push(F - ra), A.push(H), v.push(F + Aa), A.push(H), !La || isNaN(N) || isNaN(R) || (isNaN(B) || (T.push(B), U.push(N - ra)), T.push(R), U.push(N - ra), T.push(R), U.push(N + Aa))) : (isNaN(y) || (v.push(y), A.push(H - ra)), A.push(H - ra), v.push(F),
                                    A.push(H + Aa), v.push(F), !La || isNaN(N) || isNaN(R) || (isNaN(D) || (T.push(R - ra), U.push(D)), T.push(R - ra), U.push(N), T.push(R + Aa), U.push(N)));
                                x = H;
                                y = F;
                                B = R;
                                D = N;
                                ...
                                ia = H;
                                ja = F;
                                if (Ya || void 0 != z.lineColor || void 0 != z.fillColors || !isNaN(z.dashLength)) {
                                    var bc = A[A.length - 2],
                                        cc = v[v.length - 2];
                                    A.pop();
                                    v.pop();
                                    this.drawLineGraph(A, v, T, U);
                                    A = [bc];
                                    v = [cc];
                                    r ? (v.push(F + Aa), A.push(H)) : (A.push(H + Aa), v.push(F));
                                    T = [];
                                    U = [];
                                    this.lineColorSwitched = z.lineColor;
                                    this.fillColorsSwitched = z.fillColors;
                                    this.dashLengthSwitched = z.dashLength;
                                    m && (Ma ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched = Da, this.fillColorsSwitched = Ka))
                                }
                                if (Nb || z.gap) x = y = NaN, this.drawLineGraph(A, v, T, U), A = [], v = [], T = [], U = []
                            } else if (!w) {
                                if (1 >= this.periodSpan || 1 < this.periodSpan && H - x > ra + Aa) x = y = NaN;
                                this.drawLineGraph(A, v, T, U);
                                A = [];
                                v = [];
                                T = [];
                        ...
                        case "column":
                            ua = Ba;
                            void 0 != z.lineColor && (ua = z.lineColor);
                            if (!isNaN(Y)) {
                                m || (z.isNegative = Y < Ra ? !0 : !1);
                                z.isNegative && (Ka && (Ia = Ka), void 0 != Da && (ua = Da));
                                var Pb = f.min,
                                    Qb = f.max;
                                if (!(Y < Pb && na < Pb ||
                                        Y > Qb && na > Qb)) {
                                    var va;
                                    if (r) {
                                        "3d" == I ? (O = F - (t / 2 - this.depthCount + 1) * (k + S) + S / 2 + K * ca, Q = R + G * ca, va = ca) : (O = Math.floor(F - (t / 2 - ca) * (k + S) + S / 2), Q = R, va = 0);
                                        M = k;
                                        xa = H;
                                        ya = O + k / 2;
                                        ia = H;
                                        ja = O + k / 2;
                                        O + M > q + va * K && (M = q - O + va * K);
                                        O < va * K && (M += O, O = va * K);
                                        da = H - R;
                                        var dc = Q;
                                        Q = d.fitToBounds(Q, 0, n);
                                        da += dc - Q;
                                        da = d.fitToBounds(da, -Q, n - Q + G * ca);
                                        z.labelIsNegative = 0 > da ? !0 : !1;
                                        isNaN(E.percentWidthValue) || (M = this.height * E.percentWidthValue / 100, O = wb, wb += M, ya = O + M / 2);
                                        O < q && 0 < M && (pa = new d.Cuboid(h, da, M, G - a.d3x, K - a.d3y, Ia, Ta, aa, ua, V, ga, u, r, ba, $a, kb, oa),
                                            z.columnWidth = Math.abs(da), z.columnHeight = Math.abs(M))
                                    } else {
                                        "3d" == I ? (Q = H - (t / 2 - this.depthCount + 1) * (k + S) + S / 2 + G * ca, O = N + K * ca, va = ca) : (Q = H - (t / 2 - ca) * (k + S) + S / 2, O = N, va = 0);
                                        M = k;
                                        xa = Q + k / 2;
                                        ya = F;
                                        ia = Q + k / 2;
                                        ja = F;
                                        Q + M > n + va * G && (M = n - Q + va * G);
                                        Q < va * G && (M += Q - va * G, Q = va * G);
                                        da = F - N;
                                        z.labelIsNegative = 0 < da ? !0 : !1;
                                        var ec = O;
                                        O = d.fitToBounds(O, this.dy, q);
                                        da += ec - O;
                                        da = d.fitToBounds(da, -O + K * ca, q - O);
                                        isNaN(E.percentWidthValue) || (M = this.width * E.percentWidthValue / 100, Q = vb, vb += M, xa = Q + M / 2);
                                        Q < n + ca * G && 0 < M && (this.showOnAxis && (O -= K / 2), pa = new d.Cuboid(h,
                                            M, da, G - a.d3x, K - a.d3y, Ia, Ta, aa, ua, this.lineAlpha, ga, u, r, ba, $a, kb, oa), z.columnHeight = Math.abs(da), z.columnWidth = Math.abs(M))
                                    }
                                }
                                if (pa && (za = pa.set, d.setCN(a, pa.set, "graph-" + this.type), d.setCN(a, pa.set, "graph-" + this.id), z.className && d.setCN(a, pa.set, z.className, !0), z.columnGraphics = za, za.translate(Q, O), this.columnsSet.push(za), (z.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), !P)) {
                                    "none" == I && (J = r ? (this.end + 1 - L) * C - c : C * L + c);
                                    "3d" == I && (r ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, xa += G * this.columnIndex,
                                        ia += G * this.columnIndex, z.y += G * this.columnIndex) : (J = (C - c) * (L + 1) + 1E3 * this.depthCount, ya += K * this.columnIndex, ja += K * this.columnIndex, z.y += K * this.columnIndex));
                                    if ("regular" == I || "100%" == I) J = r ? 0 < Ca.value ? (this.end + 1 - L) * C + c : (this.end + 1 - L) * C - c : 0 < Ca.value ? C * L + c : C * L - c;
                                    ...
                                    this.animateColumns(pa, L, H, R, F, N);
                                    this.addListeners(za, z)
                                }
                            }
                            break;
                        case "candlestick":
                            if (!isNaN(na) && !isNaN(Y)) {
                                ...
                                void 0 != z.lineColor && (ua = z.lineColor);
                                if (r) {
                                    if (O = F - k / 2, Q = R, M = k, O + M > q && (M = q - O), 0 > O && (M += O, O = 0), O < q && 0 < M) {
                                        var Cb, Db;
                                        Y > na ? (Cb = [H, Pa], Db = [R, Oa]) : (Cb = [R, Pa], Db = [H, Oa]);
                                        !isNaN(Pa) && !isNaN(Oa) && F < q && 0 < F && (Va = d.line(h, Cb, [F, F], ua, V, aa), ab = d.line(h, Db, [F, F], ua, V, aa));
                                        da = H - R;
                                        pa = new d.Cuboid(h, da, M, G, K, Ia, Wa, aa, ua, V, ga, u, r, ba, $a, kb, oa)
                                    }
                                } else if (Q = H - k / 2, O = N + aa / 2, M = k, Q + M > n && (M = n - Q), 0 > Q && (M += Q, Q = 0), da = F - N, Q < n && 0 < M) {
                                    Ab && Y >= na && (Ta = 0);
                                    var pa = new d.Cuboid(h, M, da, G, K, Ia, Ta, aa, ua, V, ga, u, r, ba, $a, kb, oa),
                                        Eb, Fb;
                                    Y > na ? (Eb = [F, Fa], Fb = [N, Ea]) : (Eb = [N, Fa], Fb = [F, Ea]);
                                    !isNaN(Fa) && !isNaN(Ea) && H < n && 0 < H && (Va = d.line(h, [H, H], Eb, ua, V, aa), ab = d.line(h, [H, H], Fb, ua, V, aa), d.setCN(a, Va, this.bcn + "line-high"), z.className && d.setCN(a, Va, z.className, !0), d.setCN(a, ab, this.bcn + "line-low"), z.className && d.setCN(a, ab, z.className, !0))
                                }
                                pa && (za = pa.set, z.columnGraphics = za, ea.push(za), za.translate(Q, O - aa / 2), (z.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), Va && (ea.push(Va), ea.push(ab)), xa = H, ya = F, r ? (ja = F, ia = H, "open" == l && (ia = R), "high" == l && (ia = Pa), "low" == l && (ia = Oa)) : (ja = F, "open" ==
                                    l && (ja = N), "high" == l && (ja = Fa), "low" == l && (ja = Ea), ia = H), P || (z.x = r ? O + M / 2 : Q + M / 2, this.animateColumns(pa, L, H, R, F, N), this.addListeners(za, z)))
                            }
                            break;
                        case "ohlc":
                            if (!(isNaN(na) || isNaN(yb) || isNaN(zb) || isNaN(Y))) {
                                var Rb = h.set();
                                ea.push(Rb);
                                Y < na && (z.isNegative = !0, void 0 != Da && (Ba = Da));
                                var mb, nb, ob;
                                if (r) {
                                    var Gb = F - k / 2,
                                        Gb = d.fitToBounds(Gb, 0, q),
                                        Sb = d.fitToBounds(F, 0, q),
                                        Hb = F + k / 2,
                                        Hb = d.fitToBounds(Hb, 0, q);
                                    nb = d.line(h, [R, R], [Gb, Sb], Ba, V, aa, ba);
                                    0 < F && F < q && (mb = d.line(h, [Oa, Pa], [F, F], Ba, V, aa, ba));
                                    ob = d.line(h, [H, H], [Sb, Hb],
                                        Ba, V, aa, ba);
                                    ja = F;
                                    ia = H;
                                    "open" == l && (ia = R);
                                    ...
                                    var Ib = H - k / 2,
                                        ...
                                        Tb = d.fitToBounds(H, 0, n),
                                        Jb = H + k / 2,
                                        Jb = d.fitToBounds(Jb, 0, n);
                                    nb = d.line(h, [Ib, Tb], [N, N], Ba, V, aa, ba);
                                    0 < H && H < n && (mb = d.line(h, [H, H], [Ea, Fa], Ba, V, aa, ba));
                                    ob = d.line(h, [Tb, Jb], [F, F], Ba, V, aa, ba);
                                    ja = F;
                                    "open" == l && (ja = N);
                                    "high" == l && (ja = Fa);
                                    "low" == l && (ja = Ea);
                                ...
                                d.setCN(a, mb, this.bcn +
                                    "stroke");
                                z.className && d.setCN(a, Rb, z.className, !0);
                                xa = H;
                                ya = F
                            }
                    }
                    if (!P && !isNaN(Y)) {
                        ...
                        if (this.end - this.start <= Ub || 0 === Ub) {
                            var Vb = this.createBullet(z, ia, ja, L),
                                Wb = this.labelText;
                            if (Wb && Vb) {
                                var Kb = this.createLabel(z, ia, ja, Wb);
                                (Kb = this.positionLabel(xa, ya, Kb, Vb, M, da)) && this.allBullets.push(Kb)
                            }
                            if ("regular" == I || "100%" == I) {
                                var Xb = f.totalText;
                                if (Xb) {
                                    var Qa = this.createLabel(z, 0, 0, Xb, f.totalTextColor);
                                    ...
                                    r ? (cb = ya, bb = 0 > Y ? H - Zb / 2 - 2 - db - pb : H + Zb / 2 + 3 + db + pb) : (bb = xa, cb = 0 > Y ? F + $b / 2 + db + pb : F - $b / 2 - 3 - db - pb);
                                    Qa.translate(bb, cb);
                                    f.totals[L] = Qa;
                                    r ? (0 > cb || cb > q) && Qa.remove() : (0 > bb || bb > n) && Qa.remove()
                                }
                            }
                        }
                    }
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(A, v, T, U) : this.drawLineGraph(A, v, T, U), P || this.launchAnimation();
            this.bulletsHidden && this.hideBullets();
            this.customBulletsHidden &&
        ...
        drawLineGraph: function(a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                u && (r = u);
                var u = h.fillColorsR,
                    w = h.fillColorsSwitched;
                w && (u = w);
                var A = h.dashLength;
                (w = h.dashLengthSwitched) && (A = w);
                var w = h.negativeLineColor,
                    v = h.negativeFillColors,
                    x = h.negativeFillAlphas,
                    y = h.baseCoord;
                0 !== h.negativeBase && (y = h.valueAxis.getCoordinate(h.negativeBase), y > h.height && (y = h.height), 0 > y && (y = 0));
                q = d.line(l, a, b, r, q, p, A, !1, !0, f);
                ...
                void 0 === w || h.useNegativeColorIfDown || (p = d.line(l, a, b, w, t, p, A, !1, !0, f), d.setCN(k, p, h.bcn + "stroke"), d.setCN(k, p, h.bcn + "stroke-negative"), n.push(p));
                if (0 < g || 0 < x)
                    if (p = a.join(";").split(";"), t = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), t = b.concat(e)) : "radar" == q ? (t.push(0), p.push(0)) : h.rotate ? (t.push(t[t.length -
                            ...
                            t, u, g, 1, "#000", 0, a, f), b.pattern(h.pattern, NaN, k.path), d.setCN(k, b, h.bcn + "fill"), m.push(b)), v || void 0 !== w) isNaN(x) && (x = g), v || (v = w), f = d.polygon(l, p, t, v, x, 1, "#000", 0, a, f), d.setCN(k, f, h.bcn + "fill"), d.setCN(k, f, h.bcn + "fill-negative"), f.pattern(h.pattern, NaN, k.path), n.push(f), n.click(function(a) {
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                k.push(m.path);
                void 0 !== t && (n = new d.Bezier(g, a, b, t, v, n, r, 0, h), d.setCN(f, n, this.bcn + "stroke"), d.setCN(f, n, this.bcn + "stroke-negative"), l.push(n.path));
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + A + "," + b[b.length - 1], n += " L" + A + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + A,
                    n += " L" + a[0] + "," + A), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN, 0, 0, r, q, h, n), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== t) && (w || (w = q), u || (u = t), a = new d.Bezier(g, a, b, NaN, 0, 0, u, w, h, n), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        },
        ...
        legendKeyAlpha: function() {
            ...
            void 0 === a && (a = this.lineAlpha, this.fillAlphas >
                a && (a = this.fillAlphas), 0 === a && (a = this.bulletAlpha), 0 === a && (a = 1));
            return a
        },
        createBullet: function(a, b, c) {
            if (!isNaN(b) && !isNaN(c)) {
                ...
                if (this.customBullet || a.customBullet) r = this.customBullet, a.customBullet && (r = a.customBullet), r && (p && p.remove(), "function" == typeof r ? (r = new r, r.chart = e, a.bulletConfig && (r.availableSpace = c, r.graph = this, r.graphDataItem = a, r.bulletY = c, a.bulletConfig.minCoord = this.minCoord -
                    c, r.bulletConfig = a.bulletConfig), r.write(h), p && r.showBullet && r.set.push(p), a.customBulletGraphics = r.cset, p = r.set) : (p = h.set(), h = h.image(r, 0, 0, g, g), p.push(h), this.centerCustomBullets && h.translate(-g / 2, -g / 2)));
                if (p) {
...
(function() {
    ...
    d.ChartCursor = d.Class({
        ...
        hideCursor: function(a) {
            void 0 === a && (a = !0);
            this.leaveCursor ? this.hideValueBalloon() : (this.hideReal(), a && this.fire("onHideCursor", {
                type: "onHideCursor",
                chart: this.chart,
                target: this
        ...
        updateCursor: function(a, b, c) {
            var e = this.chart,
                ...
                f = e.mouseX - this.x,
                g = e.mouseY - this.y;
            this.drawingNow && (d.remove(this.drawingLine), this.drawingLine = d.line(this.container, [this.x +
                this.drawStartX, this.x + f
            ], [this.y + this.drawStartY, this.y + g], this.cursorColor, 1, 1));
            if (this.enabled) {
                void 0 === b && (b = !0);
                ...
                if (t) {
                    var w = t.x[k.id],
                        ...
                        J = this.panning,
                        G = e.graphs;
                    if (e.mouseIsOver || C || J || this.forceShow)
                        if (this.forceShow = !1, J) {
                            b = this.panClickPos;
                            ...
                            var e = this.panClickStartTime,
                                ...
                                f = (A ? b - g : b - f) / v;
                            if (!k.parseDates || k.equalSpacing) f = Math.round(f);
                            0 !== f && (b = {
                                type: "zoomed",
                                target: this
                            }, b.chart = this.chart, k.parseDates && !k.equalSpacing ? (a + f > B && (f = B - a), e + f < y && (f = y - e), b.start = Math.round(e + f), b.end = Math.round(a + f), this.fire(b.type, b)) : C + f >= this.data.length || 0 > K + f || (b.start = K + f, b.end = C + f, this.fire(b.type, b)))
                        } else {
                            "start" == D ? w -= k.cellWidth / 2 : "mouse" == D && (e.mouseIsOver ?
                                w = A ? g - 2 : f - 2 : isNaN(this.tempPosition) || (w = this.tempPosition - 2));
                            if (A) {
                                if (0 > w)
                                    if (C) w = 0;
                                    else {
                            ...
                            y = this.line;
                            0 < this.cursorAlpha && (A ? (B = 0, v = w + m, h && (v -= k.cellWidth / 2)) : (B = w, v = 0, h && (B -= k.cellWidth / 2)), D = this.animationDuration, 0 < D && !this.zooming ? isNaN(this.previousX) ? y.translate(B, v) : (y.translate(this.previousX, this.previousY), y.animate({
                                translate: B +
                                    "," + v
                            }, D, "easeOutSine")) : y.translate(B, v), this.previousX = B, this.previousY = v, y.show());
                            this.linePos = A ? w + m : w;
                            C && (h && y.hide(), A ? this.updateSelectionSize(NaN, w) : this.updateSelectionSize(w, NaN));
                            B = !0;
                            C && (B = !1);
                            this.categoryBalloonEnabled && B && (this.setBalloonPosition(x, k, w, A), (y = this.categoryBalloonFunction) ? x.showBalloon(y(t.category)) : (y = w = "", k.parseDates ? (w = d.formatDate(t.category, this.categoryBalloonDateFormat, e), k = d.changeDate(new Date(t.category), e.categoryAxis.minPeriod, 1), y = d.formatDate(k, this.categoryBalloonDateFormat,
                                e), -1 != w.indexOf("fff") && (w = d.formatMilliseconds(w, t.category), y = d.formatMilliseconds(y, k))) : (w = d.fixNewLines(t.category), u && (y = d.fixNewLines(u.category))), k = this.categoryBalloonText.replace(/\[\[category\]\]/g, String(w)), k = k.replace(/\[\[toCategory\]\]/g, String(y)), x.showBalloon(k)));
                            G && this.bulletsEnabled && this.showBullets();
                            if (this.oneBalloonOnly) {
                                w = Infinity;
                                for (k = 0; k < G.length; k++) x = G[k], x.showBalloon && !x.hidden && x.balloonText && (u = t.axes[x.valueAxis.id].graphs[x.id], y = u.y, "top" == x.showBalloonAt &&
                                    (y = 0), "bottom" == x.showBalloonAt && (y = this.height), isNaN(y) || (A ? Math.abs(f - y) < w && (w = Math.abs(f - y), K = x) : Math.abs(g - y) < w && (w = Math.abs(g - y), K = x)));
                                this.mostCloseGraph && (K = this.mostCloseGraph)
                            }
                            if (!c && (a != this.previousIndex || K != this.previousMostCloseGraph) && (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], G && this.valueBalloonsEnabled && B && e.balloon.enabled)) {
                                this.valueBalloons = c = [];
                                for (k = 0; k < G.length; k++)
                                    if (x = G[k], y = NaN, (!this.oneBalloonOnly || x == K) && x.showBalloon && !x.hidden &&
                                        x.balloonText && ("step" == x.type && "left" == x.stepDirection && (t = this.data[a + 1]), t)) {
                                        if (u = t.axes[x.valueAxis.id].graphs[x.id]) y = u.y;
                                        "top" == x.showBalloonAt && (y = 0);
                                        "bottom" == x.showBalloonAt && (y = this.height);
                                        if (this.showNextAvailable && isNaN(y) && a + 1 < this.data.length)
                                            for (B = a + 1; B < this.data.length; B++)
                                                if (w = this.data[B])
                                                    if (u = w.axes[x.valueAxis.id].graphs[x.id], y = u.y, !isNaN(y)) break;
                                        if (!isNaN(y)) {
                                            w = u.x;
                                            v = !0;
                                            if (A) {
                                            ...
                                            v && (v = this.graphBulletSize,
                                                ...
                                                (v.color = x.balloonTextColor), v.setPosition(B + n, w + q), B = e.formatString(x.balloonText, u, !0), (w = x.balloonFunction) && (B = w(u, x).toString()), "" !== B && (A ? v.showBalloon(B) : (v.text = B, v.show = !0), c.push({
                                                    yy: y,
                                                    balloon: v
                                                })), !A && v.set && (v.set.hide(), x = v.textDiv) && (x.style.visibility = "hidden"))
                                        }
                                    }
                            ...
                            b ? (b = {
                                type: "changed"
                            }, b.index = a, b.chart = this.chart, b.zooming = C, b.mostCloseGraph = K, b.position = A ? g : f, b.target = this, e.fire("changed", b), this.fire("changed", b), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, e.updateLegendValues(a));
        ...
        setBalloonPosition: function(a, b, c, e) {
            ...
            var g = this.chart,
                ...
                n = this.width,
                q = this.height;
            e ? (f && ("right" == d ? a.setBounds(l, m + g, l + n + k, m + c + g) : a.setBounds(l, m + g, l + n + k, m + c)), "right" == d ? f ? a.setPosition(l + n + k, m + c + g) : a.setPosition(l + n + k + b, m + c + g) : f ? a.setPosition(l, m + c) : a.setPosition(l - b, m + c)) : "top" == d ? f ? a.setPosition(l +
                c + k, m + g) : a.setPosition(l + c + k, m + g - b + 1) : f ? a.setPosition(l + c, m + q) : a.setPosition(l + c, m + q + b - 1)
        },
        setBalloonBounds: function(a, b, c) {
            var e = b.position,
                ...
                q = this.width,
                p = this.height;
            c ? (d && (a.pointerWidth = 0), "right" == e ? d ? a.setBounds(m, n + k, m + q + l, n + p + k) : a.setBounds(m + q + l + f, n + k, m + q + 1E3, n + p + k) : d ? a.setBounds(m, n, q + m, p + n) : a.setBounds(-1E3, -1E3, m - g - f, n + p + 15)) : (a.maxWidth = q, b.parseDates && (g = 0, a.pointerWidth = 0), "top" == e ? d ? a.setBounds(m +
                l, n + k, q + l + m, p + n) : a.setBounds(m + l, -1E3, q + l + m, n + k - g - f) : d ? a.setBounds(m, n, q + m, p + n - g) : a.setBounds(m, n + p + g + f - 1, m + q, n + p + g + f))
        },
                ...
                if (this.enabled && 0 <
                    ...
                    if (this.pan) this.rolledOver = !1;
                        ...
                        if ("cursor" == this.type) this.rotate ? this.selectionPosY = h : this.selectionPosX = h = e, 4 > Math.abs(h - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) : (c.end = this.index, c.start = this.fromIndex), h = a.categoryAxis, h.parseDates && !h.equalSpacing && (b[c.start] && (c.start = b[c.start].time),
                            b[c.end] && (c.end = a.getEndTime(b[c.end].time))), this.skipZoomDispatch || this.fire(c.type, c));
                        else {
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        update: function() {
            ...
            if (k) {
                ...
                n.mouseIsOver && (this.dragging && (n = this.initialCoord, m ? (a = n + (t - a), 0 > a && (a = 0), n = p - k, a > n && (a = n), g.setAttr("y", a)) : (a = n + (r - a), 0 > a && (a = 0), n = q - l, a > n && (a = n), g.setAttr("x", a)), this.clipDragger(!0)), this.resizingRight && (m ? (a = t - e, a + e > p + f && (a = p - e + f), 0 > a ? (this.resizingRight = !1, b = this.resizingLeft = !0) : (0 === a && (a = .1), g.setAttr("height", a))) :
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + C + "max-width:" + this.maxWidth + "px; font-size:" + y + "px; color:" + this.color + "; font-family:" + x + '">' + this.text + "</div>";
                    c.chartDiv.appendChild(n);
                    this.textDiv = n;
                    y = n.offsetWidth;
                    x = n.offsetHeight;
                    n.clientHeight && (y = n.clientWidth, x = n.clientHeight);
                    x += 2 * u;
                    C = y + 2 * t;
                    !isNaN(D) && C < D && (C = D);
                    window.opera && (x += 2);
                    ...
                    "H" != A ? (D = a - C / 2, b < k + x + 10 && "down" != A ? (J = !0, e && (b += y), y = b + w, this.deltaSignY = -1) : (e && (b -= y), y = b - x - w, this.deltaSignY = 1)) : (2 * w > x && (w = x / 2), y = b - x / 2, a < g + (l - g) / 2 ? (D = a + w, this.deltaSignX = -1) : (D = a - C - w, this.deltaSignX = 1));
                    y + x >= m && (y = m - x);
                    y < k && (y = k);
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    ...
                    0 < v || 0 === w ? (0 < u && (a = d.rect(h,
                        ...
                        0, t, G, u), a.translate(1, 1), f.push(a)), q = d.polygon(h, r, v, q, this.fillAlpha, t, p, this.borderAlpha));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parseSerialData: function(a) {
            ...
            if (a) {
                ...
                var u = {};
                this.lookupTable = u;
                var w, A = this.dataDateFormat,
                    v = {};
                for (w = 0; w < a.length; w++) {
                    var x = {},
                        y = a[w];
                    c = y[this.categoryField];
                    x.dataContext = y;
                    x.category = g ? g(c, y, k) : String(c);
                    l && (x.forceShow = y[l]);
                    n && (x.className = y[n]);
                    m && (x.labelColor = y[m]);
                    u[y[h]] = x;
                    if (f && (k.categoryFunction ? c = k.categoryFunction(c, y, k) : (!A || c instanceof Date || (c = c.toString() + " |"), c = d.getDate(c, A, k.minPeriod)), c = d.resetDateToMin(c, q, p, k.firstDayOfWeek), x.category = c, x.time = c.getTime(), isNaN(x.time))) continue;
                    ...
                    for (D = 0; D < B.length; D++) {
                        ...
                        for (J = 0; J < b.length; J++) {
                            ...
                            var G = c.id,
                                K = 1.1;
                            isNaN(c.gapPeriod) || (K = c.gapPeriod);
                            var I = c.periodValue;
                            if (c.valueAxis.id == C) {
                                x.axes[C].graphs[G] = {};
                                var X = {};
                                ...
                                var fa = y;
                                c.dataProvider && (fa = e);
                                X.values = this.processValues(fa, c, I);
                                !c.connect && v && v[G] && 0 < K && x.time - r[G] >= t * K && (v[G].gap = !0);
                                this.processFields(c, X, fa);
    ...
    d.AmRectangularChart = d.Class({
        ...
        drawZoomOutButton: function() {
            ...
            if (!a.zbSet) {
                ...
                var p = m = 0;
                void 0 !== a.pathToImages && f && (q = a.container.image(a.pathToImages + f + a.extension, 0, 0, h, h), d.setCN(a, q, "zoom-out-image"), b.push(q), q = q.getBBox(), m = q.width + 5);
                void 0 !== g && (c = d.text(a.container, g, c, a.fontFamily, e, "start"), d.setCN(a, c, "zoom-out-label"), e = c.getBBox(), p = q ? q.height / 2 - 3 : e.height / 2, c.translate(m,
                    p), b.push(c));
                q = b.getBBox();
                c = 1;
                d.isModern || (c = 0);
...
(function() {
    ...
    d.TrendLine = d.Class({
        ...
        draw: function() {
            ...
            r && !v && (isNaN(t) || (e = r.getCoordinate(t)), isNaN(u) || (h = r.getCoordinate(u)));
            p && !v && (isNaN(w) || (f = p.getCoordinate(w)), isNaN(A) || (g = p.getCoordinate(A)));
...
(function() {
    ...
    d.bullet = function(a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        switch (b) {
            case "round":
                r = d.circle(a, c / 2, e, h, f, g, k);
                break;
            case "square":
                r = d.polygon(a, [-c / 2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, h, f, g, k, m - 180, void 0, p);
                break;
            case "rectangle":
                r = d.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, h, f, g, k, m - 180, void 0, p);
                break;
            case "diamond":
                r = d.polygon(a, [-c / 2, 0, c / 2, 0], [0, -c / 2, 0, c / 2], e, h, f, g, k);
                break;
            case "triangleUp":
                r = d.triangle(a, c, 0, e, h, f, g, k);
                break;
            case "triangleDown":
                r = d.triangle(a, c, 180, e, h, f, g, k);
                break;
            case "triangleLeft":
                r = d.triangle(a, c, 270, e, h, f, g, k);
                break;
            case "triangleRight":
                r = d.triangle(a, c, 90, e, h, f, g, k);
                break;
            case "bubble":
                r = d.circle(a, c / 2, e, h, f, g, k, !0);
                break;
            case "line":
                r = d.line(a, [-c / 2, c / 2], [0, 0], e, h, f, g, k);
                break;
            case "yError":
                r = a.set();
                r.push(d.line(a, [0, 0], [-c / 2, c / 2], e, h, f));
                r.push(d.line(a, [-l, l], [-c / 2, -c / 2], e, h, f));
                r.push(d.line(a, [-l, l], [c / 2, c / 2], e, h, f));
                break;
            case "xError":
                r = a.set(), r.push(d.line(a, [-c / 2, c / 2], [0, 0], e, h, f)), r.push(d.line(a, [-c / 2, -c / 2], [-l, l], e, h, f)), r.push(d.line(a, [c / 2, c / 2], [-l, l], e, h, f))
        }
        r && r.pattern(n, NaN, q);
        return r
    };
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        e = a.set();
        var K;
        u && (w = r(10 * w), x = r(10 * x), B = r(10 * B), C = r(10 * C), v = r(10 * v), y = r(10 * y), D = r(10 * D), A = r(10 * A), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, t *= 10, 1 > Math.abs(h) && 1 >= Math.abs(B - x) && 1 >= Math.abs(D -
            y) && (K = !0));
        h = "";
        var I;
        q && (J["fill-opacity"] = 0, J["stroke-opacity"] = m["stroke-opacity"] / 2, J.stroke = m.stroke);
        if (0 < l) {
            I = " M" + w + "," + (v + l) + " L" + x + "," + (y + l);
            u ? (K || (I += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + x + "," + (y + l) + "," + B + "," + (D + l)), I += " L" + C + "," + (A + l), 0 < k && (K || (I += " B" + (b - k) + "," + (l + c - t) + "," + (b + k) + "," + (l + c + t) + "," + C + "," + (l + A) + "," + w + "," + (l + v)))) : (I += " A" + f + "," + g + ",0," + G + ",1," + B + "," + (D + l) + " L" + C + "," + (A + l), 0 < k && (I += " A" + k + "," + t + ",0," + G + ",0," + w + "," + (v + l)));
            I += " Z";
            var X = l;
            u && (X /= 10);
            for (var fa =
            ...
            I = a.path(" M" + w + "," + v + " L" + w + "," + (v + l) + " L" + x + "," + (y + l) + " L" + x + "," + y + " L" + w + "," + v + " Z", void 0, void 0, "1000,1000").attr(J);
            l = a.path(" M" + B + "," + D + " L" + B + "," + (D + l) + " L" + C + "," + (A + l) + " L" + C + "," + A + " L" + B + "," + D + " Z", void 0, void 0, "1000,1000").attr(J);
            e.push(I);
            e.push(l)
        }
        u ? (K || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(x) + "," + r(y) + "," + r(B) + "," + r(D)), f = " M" + r(w) + "," + r(v) + " L" + r(x) + "," + r(y) + h + " L" + r(C) +
            "," + r(A)) : f = " M" + w + "," + v + " L" + x + "," + y + (" A" + f + "," + g + ",0," + G + ",1," + B + "," + D) + " L" + C + "," + A;
        0 < k && (u ? K || (f += " B" + (b - k) + "," + (c - t) + "," + (b + k) + "," + (c + t) + "," + C + "," + A + "," + w + "," + v) : f += " A" + k + "," + t + ",0," + G + ",0," + w + "," + v);
        a.handDrawn && (b = d.line(a, [w, x], [v, y], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]), e.push(b));
    ...
    d.adjustLuminosity = function(a, b) {
        ...
        6 > a.length && (a = String(a[0]) + String(a[0]) + String(a[1]) + String(a[1]) + String(a[2]) +
            String(a[2]));
        b = b || 0;
        var c = "#",
            e, h;
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (x = 0; x < A.length; x++) {
                var J = A[x];
                this.reversedOrder && (J = A[A.length - x - 1]);
                v = J.getBBox();
                var G;
                this.equalWidths ? G = y * (p + n + this.markerLabelGap) : (G = B, B = B + v.width + f + n);
                v.height > C && (C =
                    v.height);
                G + v.width > q && 0 < x && 0 !== y && (r++, G = y = 0, B = G + v.width + f + n, D = D + C + m, C = 0);
                J.translate(G, D);
                y++;
                !isNaN(l) && y >= l && (y = 0, r++, D = D + C + m, B = f, C = 0);
                w.push(J)
            }
            v = w.getBBox();
            l = v.height + 2 * m - 1;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), g.push(n), a.bullet && (a.hidden || (e = a.bulletColorR),
                        n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), p = 0, n = m, q = m / 3;
                    else {
                        var r;
                        a.getGradRotation && (r = a.getGradRotation(), 0 === r && (r = 180));
                        n = a.fillColorsR;
                        !0 === a.hidden && (n = e);
                        if (g = this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, r, g, a.dashLength)) p = m, g.translate(p, m / 2);
                        n = m
                    }
                    d.setCN(b, g, "graph-" + c);
                ...
                r = this.fontSize;
                g && (m <= r && g.translate(p, m / 2 + this.ly - r / 2 + (r + 2 - m) / 2 - q), a.legendEntryWidth = g.getBBox().width);
                var u;
...
(function() {
    ...
    d.formatDate = function(a, b, c) {
        ...
        b = b.replace(/J/g, q);
        t = k;
        0 === t && (t = 24, -1 != b.indexOf("H") && (f--, 0 === f && (e = new Date(a), e.setDate(e.getDate() - 1), h = e.getMonth(), f = e.getDate(), e = e.getFullYear())));
        a = h + 1;
        9 > h && (a = "0" + a);
        q = f;
        10 > f && (q = "0" + f);
    ...
    d.changeDate = function(a, b, c, e, h) {
        if (d.useUTC) return d.changeUTCDate(a,
            b, c, e, h);
        var f = -1;
        void 0 === e && (e = !0);
        void 0 === h && (h = !1);
