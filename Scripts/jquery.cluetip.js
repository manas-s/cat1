...
(function($) {
  ...
  $.fn.cluetip = function(js, options) {
    ...
    this.each(function(index) {
      ...
      $link.data('cluetip', {title: link.title, zIndex: cluezIndex, selector: cluetipSelector, cursor:  ''});
    ...
    var cluetipShow = function(bpY) {
      ...
      if (opts.sticky) {
        if (stickyClose[opts.closePosition]) {
          $closeLink = $('<div class="cluetip-close"><a href="javascript:void(0);">' + opts.closeText + '</a></div>');
